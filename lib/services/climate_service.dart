...
const String apiKey = 'BscDaxFAClp2E1BUuukcBE3Irw2M1km4';

class ClimateService {
  static const String baseUrl = 'https://api.tomorrow.io/v4/timelines';
  static const String fields =
      'precipitationIntensity,precipitationProbability,temperature,'
      'windSpeed,humidity,precipitationType,weatherCode';
  ...
  Future<List<dynamic>?> fetchClimateData(
    ...
    try {
      ...
      debugPrint('Error fetching climate data: $error');
      return null; // Retorna null si hay un error by JG
    }
  }

  // Método para construir la URL de la API basada en las coordenadas by JG
  String buildApiUrl(
    LatLng location,
    String startTime,
    String endTime,
